...
class turtle_PID():
    ...
    def __init__(self):
        ...
        self.distance_PID.setKp(1.5)
        self.distance_PID.setKi(0.1)
        self.distance_PID.setKd(1.5)
    ...
    def angular_controller(self):
        ...
        self.R = math.sqrt(math.pow(self.current_pose_x - self.goal_x, 2) +
                           math.pow(self.current_pose_y - self.goal_y, 2))
        ...
        self.C = math.sqrt(math.pow(self.xim - self.goal_x, 2) +
                           math.pow(self.yim - self.goal_y, 2))
    ...
    def distance_controller(self):
        ...
        self.distance = math.sqrt(math.pow(self.goal_x - self.current_pose_x,
                                           2) + math.pow(self.goal_y - self.current_pose_y, 2))
